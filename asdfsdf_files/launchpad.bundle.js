...
var _utils = __webpack_require__(4093);
...
var _config = _interopRequireDefault(__webpack_require__(8274));
var _log = _interopRequireDefault(__webpack_require__(8730));
var portal = _interopRequireWildcard(__webpack_require__(4960));
exports.portal = portal;
var cmpStorage = _interopRequireWildcard(__webpack_require__(3613));
exports.cmpStorage = cmpStorage;
var cmpUtils = _interopRequireWildcard(__webpack_require__(4093));
...
var _default = logLevels.reduce((logger, funcName, index) => {
...
var _v = _interopRequireDefault(__webpack_require__(4437));

var _v2 = _interopRequireDefault(__webpack_require__(1472));

var _v3 = _interopRequireDefault(__webpack_require__(3994));

var _v4 = _interopRequireDefault(__webpack_require__(468));

var _nil = _interopRequireDefault(__webpack_require__(8570));

var _version = _interopRequireDefault(__webpack_require__(739));

var _validate = _interopRequireDefault(__webpack_require__(1753));

var _stringify = _interopRequireDefault(__webpack_require__(1163));

var _parse = _interopRequireDefault(__webpack_require__(8349));
...
var _rng = _interopRequireDefault(__webpack_require__(8024));

var _stringify = __webpack_require__(1163);
...
var _v = _interopRequireDefault(__webpack_require__(8722));

var _md = _interopRequireDefault(__webpack_require__(4305));
...
var _native = _interopRequireDefault(__webpack_require__(2088));
...
var _sha = _interopRequireDefault(__webpack_require__(1254));
...
var _regex = _interopRequireDefault(__webpack_require__(1261));
...
Object.defineProperty(exports, "isEcstModuleLoaded", ({
  enumerable: true,
  get: function () {
    return _ecst.isEcstModuleLoaded;
  }
}));
Object.defineProperty(exports, "isLocationSupportedByEcst", ({
  enumerable: true,
  get: function () {
    return _ecst.isLocationSupportedByEcst;
  }
}));
...
var _ecst = __webpack_require__(4199);
...
exports.sendDataToEcst = exports.isLocationSupportedByEcst = exports.isEcstModuleLoaded = void 0;
var _enums = __webpack_require__(4109);
...
const isEcstModuleLoaded = (isLocationSupported, ecst) => isLocationSupported && ecst && ecst.enabled;
exports.isEcstModuleLoaded = isEcstModuleLoaded;
...
exports.IDENTIFIER_TYPES = IDENTIFIER_TYPES;
const COUNTRY_CODE = {
  UNITED_STATES: 'US',
  AUSTRALIA: 'AU',
  JAPAN: 'JP',
...
exports.ECST_SEGMENTS_URL = ECST_SEGMENTS_URL;
...
exports["default"] = void 0;
var _gppConsentHandler = _interopRequireDefault(__webpack_require__(3305));
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : {
    default: obj
  };
}
var _default = _gppConsentHandler.default;
exports["default"] = _default;
...
var _enums = __webpack_require__(2424);
...
exports.GPP_SECTION_IDS = GPP_SECTION_IDS;
const US_STATES = {
  CALIFORNIA: 'CA',
  VIRGINIA: 'VA',
  COLORADO: 'CO',
...
exports.API_PREFIX_STRING = API_PREFIX_STRING;
...
exports["default"] = void 0;
var _californiaConsent = __webpack_require__(2252);
var _virginiaConsent = __webpack_require__(7345);
var _coloradoConsent = __webpack_require__(706);
var _utahConsent = __webpack_require__(1442);
var _connecticutConsent = __webpack_require__(4652);
var _usNationalConsent = __webpack_require__(7045);
var _enums = __webpack_require__(2424);
...
const defaultConfig = __webpack_require__(7028);
const config = {};
config.generate = libraryVersion => ({
  ...defaultConfig,
  env: '',
  libraryVersion,
  geoTargetingUrl: 'https://geo-dev.console.fktr.io',
  ccpaConfigUrl: 'https://ccpa-wrapper-dev.console.fktr.io/ccpa',
  gdprConfigUrl: 'https://gdpr-wrapper-dev.console.fktr.io/gdpr',
  globalCmpConfigUrl: 'https://cmp-wrapper-dev.console.fktr.io',
  gppConfigUrl: 'https://gpp-wrapper-dev.console.fktr.io',
  purposeListLocation: `https://cmp-vendors-dev.console.fktr.io/purpose-list.json`,
  atsConfigUrl: 'https://ats-wrapper-dev.console.fktr.io',
  gdprBundleUrl: 'https://gdpr-dev.console.fktr.io/latest/gdpr.bundle.js',
  ccpaBundleUrl: 'https://ccpa-dev.console.fktr.io/latest/ccpa.bundle.js',
  globalCmpBundleUrl: 'https://cmp-dev.console.fktr.io/latest/cmp.bundle.js',
  gppBundleUrl: 'https://gpp-dev.console.fktr.io/latest/gpp.bundle.js'
});
...
exports["default"] = void 0;
var _liverampCmpUtils = __webpack_require__(6703);
var _gppConsentHandler = _interopRequireDefault(__webpack_require__(5136));
var _ecst = __webpack_require__(9291);
var _config = _interopRequireDefault(__webpack_require__(5488));
var _enums = __webpack_require__(2373);
var _locationHandler = __webpack_require__(7149);
var _log = _interopRequireDefault(__webpack_require__(2618));
var _storage = __webpack_require__(4671);
...
class AtsHandler {
  ...
  isLocationUs = () => this.geoLocation.country === 'US';
  ...
  isAtsAllowedToLoad = (conditions, geoLocation) => {
    const geoTargetingCountries = this.getGeoTargeting(conditions);
    const domains = this.getDomains(conditions);
    if ((0, _locationHandler.isLocationSupported)(geoLocation, geoTargetingCountries) && this.isDomainFulfilled(domains, window.location.hostname)) {
      return true;
    }
  ...
  isDomainFulfilled = (domains, domain) => {
    const urlParam = (0, _storage.getUrlParam)('domain');
    if (urlParam) {
  ...
  insertAts = (id, ecst, notify) => {
    notify = notify || (() => {});
    const wrapperSrc = `${_config.default.atsConfigUrl}/ats-modules/${id}/ats.js`;
    ...
    wrapperScript.onload = () => {
      ...
      if ((0, _ecst.isEcstModuleLoaded)((0, _ecst.isLocationSupportedByEcst)(this.geoLocation.country), this.ecst)) {
        (0, _utils.dispatchModuleReadyEvent)('ecstModuleReady');
        if (ecst.enableGoogleTagInteraction) {
    ...
    if (window.googletag && window.googletag.cmd) {
      window.googletag.cmd.push(() => {
        window.googletag.pubads().addEventListener('slotRenderEnded', event => {
          ...
          this.sendDataToEcstModule(googleTagData, null, data => console.log(data), true);
        });
      });
    }
  };
  ...
  checkConsentForEcst = ecstParametersData => {
    if ((0, _ecst.isLocationSupportedByEcst)(this.geoLocation.country)) {
      if (this.isLocationUs()) {
        return ecstParametersData.uspString && ecstParametersData.uspString[2] !== 'Y' || this.gppConsentHandler && this.gppConsentHandler.checkGppSectionConsent().consent;
      }
      return !(!!window.navigator.globalPrivacyControl || _liverampCmpUtils.cmpUtils.isDoNotTrackEnabled());
    }
    return false;
  };
  sendDataToEcstModule = async (pData, ecstParametersData, callback, ecstAlreadyChecked) => {
    if (ecstAlreadyChecked || (0, _ecst.isEcstModuleLoaded)((0, _ecst.isLocationSupportedByEcst)(this.geoLocation.country), this.ecst)) {
      pData = pData || null;
      ecstParametersData = ecstParametersData || {};
...
var _locationHandler = __webpack_require__(7149);
var _log = _interopRequireDefault(__webpack_require__(2618));
var _purposeList = _interopRequireDefault(__webpack_require__(6580));
var _storage = __webpack_require__(4671);
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : {
    default: obj
...
class CmpHandler {
  ...
  getWrapperSrc = (appId, cmpType) => {
    ...
    if (cmpType === _enums.CMP_TYPES.GDPR) {
      wrapperSrc = `${_config.default.gdprConfigUrl}/${appId}/gdpr-liveramp.js`;
    } else if (cmpType === _enums.CMP_TYPES.CCPA) {
      wrapperSrc = `${_config.default.ccpaConfigUrl}/${appId}/ccpa-liveramp.js`;
    } else if (cmpType === _enums.CMP_TYPES.GLOBAL_CMP) {
      wrapperSrc = `${_config.default.globalCmpConfigUrl}/${appId}/cmp-liveramp.js`;
    } else if (cmpType === _enums.CMP_TYPES.GPP) {
      wrapperSrc = `${_config.default.gppConfigUrl}/${appId}/gpp-liveramp.js`;
    }
    return wrapperSrc;
  };
  ...
  getCmpBundleUrl = cmpType => {
    if (cmpType === _enums.CMP_TYPES.GDPR) {
      return _config.default.gdprBundleUrl;
    }
    if (cmpType === _enums.CMP_TYPES.CCPA) {
      return _config.default.ccpaBundleUrl;
    }
    if (cmpType === _enums.CMP_TYPES.GLOBAL_CMP) {
      return _config.default.globalCmpBundleUrl;
    }
    if (cmpType === _enums.CMP_TYPES.GPP) {
      return _config.default.gppBundleUrl;
    }
    return null;
  };
  ...
  findCmpBasedOnGeo = (geoLocation, cmpRules) => {
    ...
    return cmpRules.find(configCmp => {
      ...
      const isGeoTriggerFulfilled = (0, _locationHandler.isLocationSupported)(geoLocation, geoTrigger.condition);
...
exports["default"] = void 0;
var config = _interopRequireWildcard(__webpack_require__(7154));
...
const defaultConfig = {"env":"production","configVersion":null,"logging":false,"cmpRules":[],"atsRules":[],"triggers":[],"preload":true,"libraryVersion":"1.6.1","geoTargetingUrl":"https://geo.privacymanager.io","ccpaConfigUrl":"https://ccpa-wrapper.privacymanager.io/ccpa","gdprConfigUrl":"https://gdpr-wrapper.privacymanager.io/gdpr","globalCmpConfigUrl":"https://cmp-wrapper.privacymanager.io","gppConfigUrl":"https://gpp-wrapper.privacymanager.io","purposeListLocation":"https://cmp-vendors.privacymanager.io/purpose-list.json","atsConfigUrl":"https://ats-wrapper.privacymanager.io","gdprBundleUrl":"https://gdpr.privacymanager.io/latest/gdpr.bundle.js","ccpaBundleUrl":"https://ccpa.privacymanager.io/latest/ccpa.bundle.js","globalCmpBundleUrl":"https://cmp.privacymanager.io/latest/cmp.bundle.js","gppBundleUrl":"https://gpp.privacymanager.io/latest/gpp.bundle.js"} || config.generate();
function isObject(obj) {
  const type = typeof obj;
  return (type === 'function' || type === 'object' && !!obj) && obj.constructor !== Array;
}
function updateConfig(currentConfig, updates) {
  ...
  Object.keys(currentConfig).forEach(key => {
    if (currentConfig[key] && typeof currentConfig[key] === 'object') {
      if (isObject(currentConfig[key]) && updates[key]) {
        updatedConfig[key] = updateConfig(currentConfig[key], updates[key]);
      } else if (updates[key] && (updates[key].constructor === String || updates[key].constructor === Array)) {
        updatedConfig[key] = updates[key];
      } else if (currentConfig[key].constructor === String || currentConfig[key].constructor === Array) {
...
exports.CMP_COMMANDS = CMP_COMMANDS;
const GDPR_COMMANDS = {
  APPLIES: 'gdprApplies',
...
exports.GDPR_COMMANDS = GDPR_COMMANDS;
const CCPA_COMMANDS = {
  APPLIES: 'ccpaApplies',
  GET_VENDOR_LIST: 'getVendorList',
...
exports.CCPA_COMMANDS = CCPA_COMMANDS;
const GLOBAL_CMP_COMMANDS = {
  APPLIES: 'cmpApplies',
  GET_VENDOR_LIST: 'getVendorList',
  ...
  ACCEPT: 'accept',
  REJECT: 'reject',
  SHOW_CONSENT_MANAGER: 'showConsentTool',
  GET_CONSENT_CRITERIA: 'getConsentCriteria'
};
exports.GLOBAL_CMP_COMMANDS = GLOBAL_CMP_COMMANDS;
const GPP_COMMANDS = {
  APPLIES: 'cmpApplies',
...
exports.GPP_COMMANDS = GPP_COMMANDS;
...
const GA_EVENT_CATEGORY_PREFIX = 'lr';
exports.GA_EVENT_CATEGORY_PREFIX = GA_EVENT_CATEGORY_PREFIX;
...
var _atsHandler = _interopRequireDefault(__webpack_require__(3723));
var _cmpHandler = _interopRequireDefault(__webpack_require__(9257));
var _config = _interopRequireDefault(__webpack_require__(5488));
var _integrationsHandler = _interopRequireDefault(__webpack_require__(9338));
var _launchpad = _interopRequireWildcard(__webpack_require__(1202));
var _locationHandler = __webpack_require__(7149);
var _log = _interopRequireDefault(__webpack_require__(2618));
var _storage = __webpack_require__(4671);
function _getRequireWildcardCache(nodeInterop) {
...
const setLoggingFromQueryString = () => {
  const logging = (0, _storage.getUrlParam)('logging');
  if (logging === 'true' || logging === 'false') {
    _config.default.logging = logging === 'true';
  }
};
function init({
  configUpdates
}) {
  _config.default.update(configUpdates);
  setLoggingFromQueryString(_config.default);
  _log.default.debug('Using configuration: ', JSON.stringify(_config.default));
  ...
  const launchPadVersion = parseInt(_config.default.libraryVersion, 10);
  ...
  (0, _locationHandler.getLocation)().then(geoLocation => {
    ...
    // Load cmp
    launchPad.cmpHandler = new _cmpHandler.default(geoLocation, _config.default.cmpRules, launchPad.notify);
    launchPad.atsHandler = new _atsHandler.default(geoLocation, _config.default.atsRules, _config.default.triggers, launchPad.cmpHandler, launchPad.notify);
    launchPad.integrationsHandler = new _integrationsHandler.default(_config.default.triggers, launchPad.cmpHandler);
  }).catch(err => {
...
exports["default"] = void 0;
var _enums = __webpack_require__(2373);
var _eventsMapping = _interopRequireDefault(__webpack_require__(2106));
var _log = _interopRequireDefault(__webpack_require__(2618));
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : {
    default: obj
...
const GLOBAL_NAME = '__launchpad';
exports.GLOBAL_NAME = GLOBAL_NAME;
const CALL_NAME = `${GLOBAL_NAME}Call`;
exports.CALL_NAME = CALL_NAME;
const LOCATOR_NAME = `${GLOBAL_NAME}Locator`;
exports.LOCATOR_NAME = LOCATOR_NAME;
let VERSION = parseInt(_config.default.libraryVersion, 10) || 1;
...
class LaunchPad {
  ...
  commands = {
    ...
    ecst: async (pData, callback) => {
      callback = callback || (() => {});
      this.atsHandler.sendDataToEcstModule(pData, null, callback);
    },
...
const getLocationFromQueryString = location => {
  const country = (0, _storage.getUrlParam)('lrcountry');
  const region = (0, _storage.getUrlParam)('lrregion');
  if (!location) {
    return {
      country,
      region
...
const getLocation = () => {
  let location = (0, _storage.readGeoLocation)();
  location = getLocationFromQueryString(location);
  if (location && location.country) {
    return Promise.resolve(location);
  }
  return fetch(_config.default.geoTargetingUrl, {
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json'
    }
  }).then(res => res.json()).catch(err => {
    _log.default.error('Failed to fetch location: ', err);
  }).then(currentLocation => {
    if (currentLocation && currentLocation.country) {
      (0, _storage.writeGeoLocation)(currentLocation);
...
function isLocationSupported(currentLocation, configuredLocation) {
  ...
  if (configuredLocation.allCountries) {
    ...
    if (isCountryIncluded && currentLocation.country === 'US') {
...
class PurposeList {
  ...
  fetchPurposeList = () => {
    const purposeListUrl = _config.default.purposeListLocation;
...
var _uuid = __webpack_require__(8851);
var _log = _interopRequireDefault(__webpack_require__(2618));
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : {
    default: obj
...
function writeGeoLocation(geoLocation) {
  _log.default.debug('Writing geoLocation: ', geoLocation);
  writeToLocalStorage(GEO_LOCATION_NAME, JSON.stringify(geoLocation), GEO_LOCATION_MAX_AGE);
}
function readGeoLocation() {
  const geoLocation = readFromLocalStorage(GEO_LOCATION_NAME);
  _log.default.debug('Read geoLocation: ', geoLocation);
  if (geoLocation) {
    try {
      return JSON.parse(geoLocation);
    } catch (ex) {
      _log.default.debug('Error while parsing geoLocation: ', ex);
    }
  }
  return null;
}
...
var _init = _interopRequireDefault(__webpack_require__(2538));
var _launchpad = __webpack_require__(1202);
var _log = _interopRequireDefault(__webpack_require__(2618));
